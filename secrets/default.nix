/*
  ...
  IF YOU PROVIDE A SECRETS FILE, ENSURE THAT THE PRIVATE KEY EXISTS IN
  `/var/lib/sops-nix/key.txt`, OTHERWISE THE BUILD WILL FAIL. IF NO SECRETS
  FILE APPLY THERE IS NO NEED TO PROVIDE THE KEY.
*/
