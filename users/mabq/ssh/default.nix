# - In the age module.
#   The script there is in charge of decrypting the private ssh key.
# - In the zsh module.
...
in {
  ...
  #   in the age module.
  home.file.".ssh/id_ed25519.age".source = outlink "${m}/config/id_ed25519.age";
  home.file.".ssh/id_ed25519.pub".source = outlink "${m}/config/id_ed25519.pub";
}
